                                ...
                                <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                                    <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                                        <div>
                                            ...
                                            >
                                                <span className="px-3 py-0.5 text-white text-sm font-semibold leading-5 uppercase tracking-wide bg-red-700 rounded-full">
                                            ...
                                            <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                                                <span className="md:block">Faça a revisão do seu carro</span>{' '}
                                                <span className="text-black md:block">no conforto da sua casa</span>
                                            </h1>
